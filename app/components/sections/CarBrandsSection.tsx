...
const imgLamborghini =
  "https://www.figma.com/api/mcp/asset/de1594f1-2695-4824-ae0a-5f70a4e5b9a3.svg";
const imgBmw =
  "https://www.figma.com/api/mcp/asset/7d5df9e1-0334-47a5-8c5a-ff59206016e7.svg";
const imgTesla =
  "https://www.figma.com/api/mcp/asset/048a4abe-61cc-4aaf-9aa2-96013514640c.svg";
const imgCadillac =
  "https://www.figma.com/api/mcp/asset/e6a7b775-cec8-465d-b4dd-20496a9c52b7.svg";
const imgPorsche =
  "https://www.figma.com/api/mcp/asset/e07f6752-db3e-4bc3-be4a-9e5491a21707.svg";
const imgMercedes =
  "https://www.figma.com/api/mcp/asset/4563a35f-8593-4da4-8eea-b5275128a3e6.svg";
const imgLexus =
  "https://www.figma.com/api/mcp/asset/31ef2c4d-1be8-42cd-a713-26aa1fa571fc.svg";
const imgFerrari =
  "https://www.figma.com/api/mcp/asset/22618255-f70d-4972-a8fc-f4d60eb8711a.svg";
const imgNext =
  "https://www.figma.com/api/mcp/asset/43ffc2ee-3a44-488b-8fee-889a195b3c8c.svg";
        ...
        return (
          ...
          >
            <Image
              src={brand.src}
              alt={brand.name}
              width={Math.round(38 * brand.ratio)}
              height={38}
              className={[
