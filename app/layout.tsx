...
export const metadata: Metadata = {
  metadataBase: new URL("https://ba3hacash.com"), // TODO: عدّل للدومين الفعلي
  title: {
    default: "شراء سيارات مصدومة بأفضل سعر | كاش فوري وسطحة مجانية",
    template: "%s | [اسم البراند]",
  },
description:
  "تواصل معنا: 0562117196 — نشتري سيارتك المصدومة أو التالفة بأفضل سعر فوري، في جميع مدن السعودية. احصل على تقدير سعر فوري أونلاين، دفع كاش، وسطحة مجانية لنقل السيارة.",
  keywords: [
    "شراء سيارات مصدومة",
    "بيع سيارات مصدومة",
    "سيارات تشليح",
